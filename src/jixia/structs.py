...
from typing import Any, AnyStr, ClassVar, Literal, NamedTuple, Optional, Self, TypeVar

import pydantic
from pydantic import ConfigDict, Field, NonNegativeInt, TypeAdapter, model_validator
...
class Goal(BaseModel):
    ...
    is_prop: bool
    pp: str
    """Pretty-printed goal given by `Lean.Meta.ppGoal`"""
